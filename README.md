...
Последняя синхронизация V2: титульный экран дополнен полными данными спикера, а сцена «Риск нужен не для страха» — развёрнутыми факторами риска и блоком «Сосудистый контекст».
